...
public class Case {
    ...
    public Case(){
        ...
        Topping topping2 = new Topping("Oreo", 0.50, new ArrayList<>(Arrays.asList( "gluten")));
        Topping topping3 = new Topping("Blueberries", 0.50, new ArrayList<>(Arrays.asList( "blueberry")));
        Topping topping4 = new Topping("Snickers", 0.50, new ArrayList<>(Arrays.asList( "nuts")));
        Topping topping5 = new Topping("Twix", 0.50, new ArrayList<>(Arrays.asList( "none")));
